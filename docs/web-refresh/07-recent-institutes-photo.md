...
The source maps one replacement to the Recent Institutes hero back image. Its current asset, visual overlap, binding, and responsive crop must be recorded in Designer before changing it.
...
- [ ] P10: the approved asset is visible at the destination specified in the mapping table.
