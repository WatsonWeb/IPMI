...
The source supplies a single back-bubble replacement. The current asset, live image binding, and front/back stack have not been recorded in this task and require screenshot comparison in Chrome.
...
- [ ] P15: the approved asset is visible at the destination specified in the mapping table.
